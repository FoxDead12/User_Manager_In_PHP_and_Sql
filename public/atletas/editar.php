            ...
            <form action="../../processes/editar_atleta.php?atleta=<?php echo $atleta_id;?>" method="POST" id="altela-visualizar" enctype="multipart/form-data">
                ...
                <div class="tipo-dados">
                    ...
                    <div class="input-container">
                        ...
                        <input type="number" name="potencia" placeholder="Potência" value="<?php echo $dados_player['potencia']; ?>" onchange="AtivarButao()">
                ...
                <div class="tipo-dados">
                    ...
                    <div class="input-container">
                        ...
                        <input type="text" disabled placeholder="Escalão" value="Escalão <?php echo $dados_player['nome_escalao']; ?>" onchange="AtivarButao()">
                    ...
                    <div class="input-container">
                        ...
                        <!-- <input type="text" onchange="AtivarButao()" placeholder="Potência" value="<?php if($dados_player['sexo'] == 0){echo "Masculino";}else{echo "Feminino";} ?>" > -->
